...
import { creatDescription,getAllDescription, getArticleById } from '../controller/description-controller.js';
...
router.get('/descriptions/:id', authenticateToken, getArticleById);
